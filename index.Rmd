...
- [Practical Assignment 1 (Deadline: xxx)](Contents/Practicals/Week 1 Assignment.pdf)


### Data
The data that should be used for the practicals can be found here.

- [2021 PHC - Education Data](Contents/Practicals/data/education.xlsx)
- [2021 PHC - Housing Data](Contents/Practicals/data/housing.xlsx)
- [2021 PHC - Population Data](Contents/Practicals/data/population.xlsx)

## Column 2

### Solutions to Practicals
After the weekly deadline, the solution to the practical will be uploaded here. (This will be after the following lecture.)

<!-- - [Solution Practical 1](Contents/Practicals/Assignment-Week-One-Solutions.html){target="_blank"} -->
