...
- Data Scientist at Ghana Statistical Service
- Very skilled in using R and other programming languages
- A lot of knowledge on what data GSS has that might be useful to you
- We worked together on the course materials and will both give some lectures
...
- Weekly assignment
- 7 weeks of core material
- One recap session
- Two presentation sessions (after the Christmas break)
- Final assessment

## Timeline
- Lecture: week 1-7 on Friday, 09:00-10:30 
  - Additional recap session (TBD)
  - No planned session in other weeks, except when schedule has to be changed due to circumstances
- Practical: week 1-7 on Friday 10:30-12:00 (after lecture)
- Presentations: in the two weeks after the Christmas break (Jan 12 and 19)
- Final assessment (Deadline = January 26)
...
- Group work: group of 3/4 people for the final assignment
...
## How to access GSS data?
- GSS Data required for the final assignment
- Main website: https://statsghana.gov.gh
  - Look at published reports
  - Which areas are still unexplored?
- Microdata: https://microdata.statsghana.gov.gh
  - Choose data that interests you
  - Request data ASAP
- Statsbank: https://statsbank.statsghana.gov.gh
  - Already generates tables
...
<span style="font-size: 2em;">https://femkevdbos.github.io/R_course_UG</span>
